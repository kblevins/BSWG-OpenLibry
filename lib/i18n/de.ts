...
export const de = {
  ...
  importPage: {
    pageTitle: "ISBN-Datei-Import | OpenLibry",
    heading: "Massen-ISBN-Import",
    subheading: "Lade eine Textdatei, CSV oder Excel-Tabelle hoch, um den gesamten Bestand auf einmal zu importieren.",
    uploadLabel: "ISBN-Datei (.txt, .csv, .xlsx)",
    uploadHint: "Textdatei: eine ISBN pro Zeile. CSV/Excel: braucht eine ISBN-Spalte; optionale Anzahl-Spalte erstellt mehrere Exemplare.",
    uploadButton: "Datei auswählen",
    noFileSelected: "Keine Datei ausgewählt",
    downloadTemplate: "CSV-Vorlage herunterladen",
    isbnCount: "{count} ISBNs gefunden",
    isbnCountWithCopies: "{isbns} ISBNs · {copies} Exemplare gesamt",
    startImport: "Import starten",
    importing: "Importiere…",
    progress: "ISBN {done} von {total}",
    resultHeading: "Import abgeschlossen",
    successCount: "{count} Bucheinträge erstellt",
    failedCount: "{count} ISBNs nicht gefunden — bitte manuell hinzufügen",
    duplicateSkipped: "{count} Duplikate übersprungen (bereits in der Bibliothek)",
    downloadFailed: "Nicht gefundene ISBNs herunterladen (.txt)",
    backButton: "Zurück zur Administration",
    columnPickerHeading: "ISBN-Spalte auswählen",
    columnPickerSubheading: "Deine Datei hat mehrere Spalten. Welche enthält die ISBNs?",
    columnPickerIsbnLabel: "ISBN-Spalte",
    columnPickerQtyLabel: "Anzahl-Spalte",
    columnPickerQtyHint: "Optional — erstellt mehrere Exemplare pro ISBN.",
    columnPickerNone: "Keine",
    columnPickerConfirm: "Weiter",
    columnSample: "Beispiel:",
  },
  adminPage: {
