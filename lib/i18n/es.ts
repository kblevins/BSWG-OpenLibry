...
export const es: Dictionary = {
  ...
  importPage: {
    pageTitle: "Importación de ISBN | OpenLibry",
    heading: "Importación masiva de ISBN",
    subheading: "Sube un archivo de texto, CSV o Excel para importar toda la colección de una vez.",
    uploadLabel: "Archivo de ISBN (.txt, .csv, .xlsx)",
    uploadHint: "Texto: un ISBN por línea. CSV/Excel: necesita una columna de ISBN; columna de cantidad opcional crea varias copias.",
    uploadButton: "Elegir archivo",
    noFileSelected: "Ningún archivo seleccionado",
    downloadTemplate: "Descargar plantilla CSV",
    isbnCount: "{count} ISBN encontrados",
    isbnCountWithCopies: "{isbns} ISBN · {copies} copias en total",
    startImport: "Iniciar importación",
    importing: "Importando…",
    progress: "ISBN {done} de {total}",
    resultHeading: "Importación completada",
    successCount: "{count} registros de libros creados",
    failedCount: "{count} ISBN no encontrados — añadir manualmente",
    duplicateSkipped: "{count} duplicados omitidos (ya en la biblioteca)",
    downloadFailed: "Descargar ISBN fallidos (.txt)",
    backButton: "Volver a la administración",
    columnPickerHeading: "Selecciona la columna de ISBN",
    columnPickerSubheading: "Tu archivo tiene varias columnas. ¿Cuál contiene los ISBN?",
    columnPickerIsbnLabel: "Columna de ISBN",
    columnPickerQtyLabel: "Columna de cantidad",
    columnPickerQtyHint: "Opcional — crea varias copias por ISBN.",
    columnPickerNone: "Ninguna",
    columnPickerConfirm: "Continuar",
    columnSample: "Muestra:",
  },
  adminPage: {
    ...
    importTitle: "Importar ISBN",
    importDescription: "Importar libros en masa desde un archivo",
    manageUsersTitle: "Gestionar usuarios",
    manageUsersDescription: "Controlar quién puede iniciar sesión",
  ...
  loginUsersPage: {
    pageTitle: "Gestionar usuarios | OpenLibry",
    heading: "Gestionar usuarios",
    subheading: "Direcciones Gmail autorizadas para iniciar sesión",
    backToAdmin: "Volver a administración",
    addHeading: "Añadir usuario",
    ...
    emptyState: "Aún no hay usuarios. Añade un correo Gmail arriba.",
    errorAdd: "Error al añadir el usuario.",
    errorUpdate: "Error al actualizar el usuario.",
    errorDelete: "Error al eliminar el usuario.",
    roleNote: "Los roles se guardan pero aún no se usan para el control de acceso. Todos los usuarios con sesión iniciada tienen el mismo nivel de acceso.",
  },
